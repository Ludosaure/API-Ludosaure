...
export class EmailReservationCanceledService {
    ...
    public sendConfirmationMail(reservation: Reservation): void {
        ...
        return this.emailService.sendMail({
            ...
            subject: `La Ludosaure - Votre réservation a été annulée`,
            html: `<!DOCTYPE html>
                    <html lang="">
                    <head>
                    ...
                    <div style="width: 100%;">
                      <div style="background-color:#ffffff; margin: auto; display: block; max-width: 600px; padding: 36px 24px 0;
                        ...
                        <h1 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">
                          Votre réservation du ${reservation.startDate.toLocaleString()} au ${reservation.endDate.toLocaleString()} a été annulée
                        </h1>
                        <p class="text">
                            Bonjour ${reservation.user.firstname} ${reservation.user.lastname},<br><br>
                            Nous vous informons que votre réservation censée débuter le ${reservation.startDate.toLocaleString()} et se terminer le ${reservation.endDate.toLocaleString()} a été annulée.<br>
